(function (angular) {
    ...
    angular.module('FileManagerApp').config(['$translateProvider', function ($translateProvider) {
        ...
        /*$translateProvider.translations('hu', {
            ...
            files_will_uploaded_to: 'A fájlok a következő mappába fognak feltöltődni',
            select_files: 'Fájlok kiválasztása',
            uploading: 'Feltöltés',
            permissions: 'Jogosultságkezelés',
            select_destination_folder: 'Kérjük válassza ki a célkönyvtárat',
            source: 'Forrás',
            destination: 'Cél',
            copy_file: 'Fájl másolása',
            sure_to_delete: 'Biztosan törölni kívánja',
            change_name_move: 'Átnevezés / áthelyezés',
            enter_new_name_for: 'Kérjük adja meg az új nevét',
            extract_item: 'Elem kicsomagolása',
            extraction_started: 'A fájl kicsomagolása elkezdődött (háttérfolyamatként)',
            compression_started: 'A fájl(ok) becsomagolása elkezdődött (háttérfolyamatként)',
            enter_folder_name_for_extraction: 'Kérjük adjon meg egy könyvtárat a kicsomagoláshoz',
            enter_file_name_for_compression: 'Kérjük adjon meg egy fájlnevet a becsomagoláshoz',
            toggle_fullscreen: 'Váltás teljes képernyőre',
            edit_file: 'Fájl szerkesztése',
            file_content: 'Fájl tartalma',
            loading: 'Töltés',
            search: 'Keresés',
            create_folder: 'Könyvtár létrehozása',
            create: 'Létrehoz',
            folder_name: 'Könyvtárnév',
            upload: 'Feltöltés',
            ...
            actions: 'Műveletek',
            date: 'Dátum',
            no_files_in_folder: 'Üres könyvtár',
            no_folders_in_folder: 'A mappa nem tartalmaz további alkönyvtárakat',
            select_this: 'Kijelölés',
            go_back: 'Visszalépés',
            wait: 'Várakozás',
            move: 'Áthelyezés',
            download: 'Letöltés',
            ...
            error_invalid_filename: 'Helytelen vagy már létező fájlnevet használt, kérjük adjon meg egy újat',
            error_modifying: 'Hiba történt a fájl módosítása során',
            error_deleting: 'Hiba történt a fájl / mappa törlése során',
            error_renaming: 'Hiba történt a fájl átnevezése során',
            error_copying: 'Hiba történt a fájl másolása során',
            error_compressing: 'Hiba történt a fájl / könyvtár becsomagolása során',
            error_extracting: 'Hiba történt a fájl kicsomagolása során',
            error_creating_folder: 'Hiba történt az új könyvtár létrehozása során',
            error_getting_content: 'Hiba történt a fájl tartalmának lekérdezése során',
            error_changing_perms: 'Hiba történt a fájl jogosultságainak módosítása során',
            error_uploading_files: 'Hiba történt a fájl(ok) feltöltése során',
            sure_to_start_compression_with: 'Biztosan szeretné becsomagolni?',
            owner: 'Tulajdonos',
            group: 'Csoport',
            others: 'Mások',
            read: 'Olvasás',
            ...
            changes: 'Módosítások',
            recursive: 'Rekurzív',
            preview: 'Elem megtekintése',
            open: 'Megnyitás',
            these_elements: 'ezen {{total}} elem',
